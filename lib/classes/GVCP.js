...
import DISCOVERY from './commands/DISCOVERY';
import READREG from './commands/READREG';

import MESSAGES from './Messages';

// var GVCP = function() {
// export function GVCP() {
export class GVCP {
  constructor() {
    var me = this;
    me.req_id = 1;
  ...
  discover(broadcastAddress) {
    var me = this;
    var cmd = new DISCOVERY.DISCOVERY();
  ...
  beat(){
    ...
    me.heartbeatInt = setTimeout(function(){
      var command = new READREG.READREG();
      //command.flag = 0;
